<template>
    <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-colum">
          ...
          <loading v-show="loading"/>
            ...
            <div class="invoice-work flex flex-column">
                ...
                <div class="input flex flex-column">
                    ...
                    <input disabled required type="text" id="paymentDueDate" v-model="paymentDueDate">
                </div>
                </div>
                <div class="input flex flex-column">
...
export default {
    ...
    watch: {
      paymentTerms(){
        ...
        this.paymentDeuDateUnix = futureDate.setDate(futureDate.getDate() + parseInt(this.paymentTerms))
        this.paymentDueDate = new Date(this.paymentDeuDateUnix).toLocaleDateString('en-us', this.dateOptions)
      }
    },
    methods:{
        ...
        async uploadInvoice(){
          ...
          await dataBase.set({
            ...
            paymentDeuDateUnix: this.paymentDeuDateUnix,
